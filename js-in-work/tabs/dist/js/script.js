...
window.addEventListener('DOMContentLoaded', () => {
  ...
  class MenuCard {
    ...
    constructor(options, ...classes) {
      ...
      this.classes = classes; //4.2 добавляем родителя в который будем помещать наш новосозданный элемент

      this.parent = document.querySelector(options.parent); //3.1 вызовем прямов в конструкторе наш метод конвертации
    ...
    render() {
      ...
      const el = document.createElement('div'); //4.6 добавим условимя что если не один класс не был добавлен элементу, до подставим ему дефолтный класс
      ...
      if (this.classes.length === 0) {
        ...
        //4.6.2 а если есть хотя бы один класс то перебором добавим его в наш элемент
