...
// const convertVariable = function (v) {
//   const [a, b] = v.split('_');
//   const newV = [a, b.replace(b[0], b[0].toUpperCase())].join('');
//   return newV;
// };
...
//   for (const t of text) {
//     const output = convertVariable(t.trim());
//     console.log(output);
//   }
// });
...
// 5.
// const { odds: newOdds } = game;
// const { team1, x: draw, team2 } = newOdds;
